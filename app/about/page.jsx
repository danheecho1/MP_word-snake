...
const About = () => {
	return (
		<>
			...
			<div className={styles.descriptionDiv}>
				<p className={styles.description}>
					...
					provide the next word within 10 seconds. Entering an invalid word also ends the game.
				</p>
				<p className={styles.description}>
					Your word will be considered valid if it is found in
					https://dictionaryapi.dev. This includes nouns (singular and plural), verbs, adjectives, adverbs, conjunctions, prepositions, and so on, but not pronouns. Entering an invalid word will
					also end the game instantly, so no guessing or making up
					random words here.
				</p>
				<p className={styles.description}>
      ...
      <Link href="/" className={styles.linkToPlay}>Click here if your brain is ready to play</Link>
		</>
	);
};
